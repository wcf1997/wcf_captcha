...
export type AliyunCaptchaInlineStyle = Record<string, AliyunCaptchaStyleValue | undefined>;
...
export type AliyunCaptchaVerifyHandler = (captchaVerifyParam: AliyunCaptchaVerifyParam) => AliyunCaptchaVerifyResult | Promise<AliyunCaptchaVerifyResult>;
